...
```bash
curl -fsSL https://raw.githubusercontent.com/thunder-edge/docs/main/install.sh | bash
```
...
curl -fsSL https://raw.githubusercontent.com/thunder-edge/docs/main/install.sh | bash -s -- --channel stable

# Latest unstable (nightly) release
curl -fsSL https://raw.githubusercontent.com/thunder-edge/docs/main/install.sh | bash -s -- --channel unstable
```
...
```bash
# By tag
curl -fsSL https://raw.githubusercontent.com/thunder-edge/docs/main/install.sh | bash -s -- --tag v1.0.0

# By commit (requires Rust toolchain -- builds from source)
curl -fsSL https://raw.githubusercontent.com/thunder-edge/docs/main/install.sh | bash -s -- --commit abc123
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/thunder-edge/docs/main/install.sh | bash -s -- --install-dir /usr/local/bin
```
